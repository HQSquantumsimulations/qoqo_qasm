...
#[test_case(Operation::from(CallDefinedGate::new("gate_name".to_owned(), vec![0, 1], vec![0.5])), "gate_name(0.5) q[0],q[1]"; "CallDefinedGate")]
...
#[test_case(Operation::from(CallDefinedGate::new("gate_name".to_owned(), vec![0, 1], vec![0.5])), ""; "CallDefinedGate")]
